...
const SwimFields = ({ route, navigation }) => {
  ...
  const [swimmingTime, setSwimmingTime] = useState(null);
    ...
    <ScrollView>
      <View style={styles.container}>
        ...
        <View style={styles.TextInputContainer}>
          ...
          <View style={styles.FieldRow}>
            <Text style={styles.TextStyle}>Swimming Time</Text>
            <TextInput
              value={swimmingTime}
              onChangeText={setSwimmingTime}
              keyboardType={"numeric"}
              placeholder="Swimming Time"
              placeholderTextColor="white"
              style={styles.TextInputStyle}
            />
          </View>
