...
const CycleFields = ({ route, navigation }) => {
  ...
  const [cyclingTime, setCyclingTime] = useState(null);
  const [avgPower, setAvgPower] = useState(null);
    ...
    <ScrollView>
      <View style={styles.container}>
        <TouchableOpacity
          onPress={() => {
            if (userType === "athlete") {
              console.log("back button of bike pressed");
        ...
        <View style={styles.TextInputContainer}>
          ...
          <View style={styles.FieldRow}>
            <Text style={styles.TextStyle}>Cycling Time</Text>
            <TextInput
              value={cyclingTime}
              onChangeText={setCyclingTime}
              keyboardType={"numeric"}
              placeholder="Cycling Time"
              placeholderTextColor="white"
              style={styles.TextInputStyle}
            />
          </View>
